...
<head>
    ...
    <link rel="stylesheet" href="contacttest.css">
...
<style> 
        <?php 
            include 'C:/xampp/htdocs/Maher-WebProject3/contacttest.css'; 
...
<body>
    ...
    <div class="map-contact-wrap">
        ...
        <div id="email-wrap">   <div id="our-email" style="box-sizing:border-box;padding:10px;padding-top:0;">  <h2> Email </h2> <br> <p> WASHEM@gmail.com </p></div> </div> 
    ...
    <div id="form-wrap-row"> 
            ...
            <div id="form">
                <form method="POST" action="contactform.php">
                    ...
                    <label for="name"  id="label-name"> Full Name </label><br>
                    <div id="email-phone-wrap" style="display:flex;gap:5px;">
                        <input type="email" name="useremail" id="email" class="inputs" style="width:50%" placeholder=" " required ><br>
                        <label for="email"  id="label-email"> Email </label>
                            <input type="number" name="phonenumber" id="number" class="inputs" style="width:50%" placeholder=" " ><br>
                            <label for="number"  id="label-number"> Phone Number </label> </div> <br>
                                ...
                                <div id="btn-wrap" style="display:flex;justify-content:center;width:100%;">  
                                    ...
                                    <label for="file"> Select Image </label> </div>
